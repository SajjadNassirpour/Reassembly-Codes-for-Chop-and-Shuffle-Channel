...
function [frag,complex_i] = other_frag_single_r(m,L,d_sec,breaks_points,data_combined,X_seperated,VT_section_length,parity,fragment_combined,r_mat_orig,length_combined,rep_frag,Main_r)
    ...
    for i=1:size(X_seperated,1)
        ...
        while La>1 && stop==0
            ...
            if valid_point_idx>residue_combined+2
                ...
                while valid_point_idx>residue_combined+2 && stop==0
